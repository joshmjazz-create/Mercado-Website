    ...
    <>
      <section className="relative min-h-screen md:fit-screen overflow-hidden" style={{ backgroundColor: '#101010' }}>
        ...
        <div className="home-wrapper relative text-center max-w-4xl mx-auto px-4 sm:px-6 lg:px-8" style={{ zIndex: 10 }}>
          <h1 className="text-6xl md:text-8xl font-bold font-display text-purple-500 mb-8 [text-shadow:0_0_6px_rgba(0,0,0,0.6),0_0_14px_rgba(0,0,0,0.45),0_0_28px_rgba(0,0,0,0.35)] opacity-0 scale-95 animate-in" style={{ 
