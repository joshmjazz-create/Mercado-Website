...
export default function FlexList() {
  ...
  return (
    <>
    <div className="min-h-screen md:fit-screen bg-slate-800 text-white" style={{ fontFamily: 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif' }}>
