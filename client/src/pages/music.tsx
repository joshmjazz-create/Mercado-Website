  ...
  const renderAlbumSection = (title: string, albums: StaticAlbum[], delay: number) => {
    if (albums.length === 0) {
      return (
        ...
        >
          <h2 className="text-3xl font-bold text-purple-400 mb-8 text-center">{title}</h2>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {albums.map((album, index) => (
            ...
            >
              <div className="bg-white bg-opacity-10 backdrop-blur-sm rounded-lg p-6 text-center h-64 flex flex-col justify-center">
    ...
    <section className="min-h-screen bg-gradient-to-br from-jazz-dark via-black to-jazz-dark">
      <div className="container mx-auto px-4 py-16">
        ...
        <Dialog open={showPlatforms} onOpenChange={setShowPlatforms}>
          <DialogContent className="bg-black border-purple-400">
